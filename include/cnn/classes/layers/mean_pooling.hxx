...
namespace CNN {
    ...
    public:
        ...
        MeanPool(size_t in_width, size_t in_height, size_t fld_width, size_t fld_height, size_t h_stride,
                 size_t v_stride);
        ...
        void
        Update_Params(Optimizer *optimizer, size_t normalizer) {/* do nothing, no parameters to learn in this layer */}
    ...
    public:
        ...
        // create MaxPool object from given parameters
        MeanPooling(size_t in_maps, size_t in_width, size_t in_height, size_t fld_width, size_t fld_height,
